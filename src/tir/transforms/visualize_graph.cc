...
//   static std::string label_edge(const relay::IndexedGraph<PrimExpr>::Node* source,
//                                 const relay::IndexedGraph<PrimExpr>::Node* target,
...
//   void add_node_arguments(const IndexedGraph<PrimExpr>::Node& node,
//                           std::unordered_map<const void*, HeightMap>& height_maps,
//                           size_t& fake_node_ctr) {
//     for (auto input_value : node.inputs_) {
//       PrimExpr arg = input_value->ref_;
...
//   std::string add_attributes(const IndexedGraph<PrimExpr>::Node& node) {
//     std::string rc;
...
//   std::string get_attributes(const IndexedGraph<PrimExpr>::Node& node) {
...
void VisualizeGraph(const PrimFunc& expr, const IRModule& mod, std::string output_path) {
