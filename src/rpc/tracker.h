...
// class PutInfo;
// class RPCTrackerImplementation;
...
// class RPCTrackerImplementation {
//  public:
//   RPCTrackerImplementation(std::string host, int port, int port_end, bool silent = true);
//   RPCTrackerImplementation(const RPCTrackerImplementation&) = delete;
//   ~RPCTrackerImplementation();
//   void Stop();
//   void Terminate();
//   int GetPort() const;
...
//    public:
//     ConnectionInfo(RPCTrackerImplementation* tracker, std::string host, int port, support::TCPSocket connection);
//     ~ConnectionInfo();
//     RPCTrackerImplementation* tracker_;
